...
namespace Interon.Roadlab.Core
{
    public class AppCenterPush
    {
        ...
        public class Constants
        {
            ...
            public const string FullAccessToken = "fe646d7bf13f025e3f068724eadb8d3154f794c6";
            ...
            public const string AppNameAndroid = "Roadlab-Xamarin-Android";

            public const string AppNameIOS = "apple.name";

            public const string Organization = "RoadLab";
        }
