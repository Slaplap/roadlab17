angular.module("umbraco")
    .controller("TransactionsController", function ($scope,   TransactionsResource, notificationsService ) {
        ...
        function fetchData() {
            $scope.loading = true;
            TransactionsResource.getPaged($scope.itemsPerPage, $scope.currentPage, $scope.predicate, $scope.reverse ? "desc" : "asc", $scope.statusFilter, $scope.searchTerm).then(function (response) {
                ...
                notificationsService.error("Error", "Could not load Transactions list");
            });
        };
