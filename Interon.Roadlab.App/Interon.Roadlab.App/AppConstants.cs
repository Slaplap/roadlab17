namespace Interon.Roadlab.App
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationChannelName { get; set; } = "RoadlabNotifyChannel";

        /// <summary>
        /// This is the name of your Azure Notification Hub, found in your Azure portal.
        /// </summary>
        public static string NotificationHubName { get; set; } = "RoadlabNotificationHub";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://roadlab.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=zk7V6U5Kw5Enf3UUS7K+AWmA7cJGDfz7XR5zorYWbpY=";

        /// <summary>
        /// Tag used in log messages to easily filter the device log
        /// during development.
        /// </summary>
        public static string DebugTag { get; set; } = "RoadlabNotify";
